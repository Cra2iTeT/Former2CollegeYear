...
fileName = open('C:\\CS\\Java\\IdeaProjects\\Lesson03\\src\\main\\java\\com\\tea\\lesson03\\function\\test.txt', 'r',
                encoding='utf-8')
readFileName = fileName.readline().strip('\n')
fileName.close()

with open("C:\\CS\\Java\\IdeaProjects\\Lesson03\\src\\main\\java\\com\\tea\\lesson03\\function\\"+readFileName, "r",
          encoding='utf-8') as f:
    TOTAL = f.readline()
...
new_file = open('C:\\CS\\Java\\IdeaProjects\\Lesson03\\src\\main\\java\\com\\tea\\lesson03\\function\\test.txt', 'r',
                encoding='utf-8')
tempBlock = new_file.readline().strip('\n')
startpos = new_file.readline().strip('\n')
endpos = new_file.readline()
new_file.close()
...
for i in range(len(ways) - 1):
    ...
    print(ways[i][0], end='')
    myList.append(ways[i][0])

    print('-', end='')

    print(ways[i][1], end='')
    myList.append(ways[i][1])
