...
@Controller
@RequestMapping("/productionFM")
public class ProductionFMController {
    @Autowired
    ...
    public String queryAllSentDocument(Model model) {
        ...
        if (documentList.size() > 0) {
            ...
            return "./manager/productionFactoryManager/queryAllSentDocumentResult";
        } else {
    ...
    public String toQueryDocumentPage() {
        return "./manager/productionFactoryManager/queryDocumentPage";
    }
    ...
    public String queryDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("productionFMController根据条件查询公文函数中");
...
//        }
        ...
        for (int i = 0; i < documentList.size(); i++) {
            if (documentList.get(i).getDepartId() != 2) {
                documentList.remove(i);
            } else {
                System.out.println("公文签审人=>" + documentList.get(i).getApproveName());
    ...
    public String toUpdateSentDocumentPage(HttpServletRequest request,
        ...
        return "./manager/productionFactoryManager/updateSentDocumentPage";
    }
    ...
    public String updateUnsignedDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("productionFMController签审公文函数中");
