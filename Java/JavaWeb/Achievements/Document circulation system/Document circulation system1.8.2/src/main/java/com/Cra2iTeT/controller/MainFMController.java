...
@Controller
@RequestMapping("/mainFM")
public class MainFMController {
    @Autowired
    ...
    public String queryAllSentDocument(Model model) {
        ...
        if (documentList.size() > 0) {
            ...
            return "./manager/mainFactoryManager/queryAllSentDocumentResult";
        } else {
    ...
    public String toQueryDocumentPage() {
        return "./manager/mainFactoryManager/queryDocumentPage";
    }
    ...
    public String queryDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("mainFMController根据条件查询公文函数中");
...
//        }
    ...
    public String toUpdateSentDocumentPage(HttpServletRequest request,
        ...
        return "./manager/mainFactoryManager/updateSentDocumentPage";
    }
    ...
    public String updateUnsignedDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("mainFMController签审公文函数中");
