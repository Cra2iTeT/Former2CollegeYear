...
$(function(){
	...
	userPassword.bind("focus",function(){
		validateTip(userPassword.next(),{"color":"#666666"},"* 密码长度必须是大于2小于20",false);
	}).bind("blur",function(){
		if(userPassword.val() != null && userPassword.val().length > 2
	...
	ruserPassword.bind("focus",function(){
		...
		if(ruserPassword.val() != null && ruserPassword.val().length > 2
