...
@Controller
@RequestMapping("/financeFM")
public class FinanceFMController {
    @Autowired
    ...
    public String queryAllSentDocument(Model model) {
        ...
        if (documentList.size() > 0) {
            ...
            return "./manager/financeFactoryManager/queryAllSentDocumentResult";
        } else {
    ...
    public String toQueryDocumentPage() {
        return "./manager/financeFactoryManager/queryDocumentPage";
    }
    ...
    public String queryDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("financeFMController根据条件查询公文函数中");
...
//        }
        ...
        for (int i = 0; i < documentList.size(); i++) {
            if (documentList.get(i).getDepartId() != 4) {
    ...
    public String toUpdateSentDocumentPage(HttpServletRequest request,
        ...
        return "./manager/financeFactoryManager/updateSentDocumentPage";
    }
    ...
    public String updateUnsignedDocument(HttpServletRequest request,
        ...
        System.out.println();
        System.out.println("================");
        System.out.println("financeFMController签审公文函数中");
